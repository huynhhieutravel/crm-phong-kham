...
$page_title = "Import Patients (Bệnh nhân)";
    ...
    if (($handle = fopen($file, "r")) !== FALSE) {
        ...
        while (($data = fgetcsv($handle, 1000, ",")) !== FALSE) {
            ...
            try {
                ...
                $gender = ($gender_raw === 'Nam' || $gender_raw === 'male') ? 'male' : (($gender_raw === 'Nữ' || $gender_raw === 'female') ? 'female' : 'other');
...
<div class="card shadow-sm" style="max-width: 600px; margin: 2rem auto; border-radius: 16px;">
    <div class="card-header bg-white" style="border-bottom: 1px solid #f1f5f9; padding: 1.5rem;">
        <h5 class="mb-0" style="font-weight: 800; color: var(--text-main);">
            <i class="fas fa-file-import text-primary mr-2"></i> Nhập dữ liệu Bệnh nhân từ CSV
        </h5>
    </div>
        ...
        <form method="POST" enctype="multipart/form-data">
            <div class="mb-4">
                ...
                <p class="text-muted mt-2" style="font-size: 0.8rem;">
                    ...
                    <a href="template_patients.csv" class="text-primary font-weight-bold">Tải file mẫu</a>
                </p>
            </div>

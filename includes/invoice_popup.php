<!-- includes/invoice_popup.php — Shared Popup Component for Invoice -->
...
<div id="ipCreateMode" style="padding:1.5rem 2rem;">
    ...
    <div style="margin-bottom:1.5rem;">
        ...
        <div style="display:grid; grid-template-columns:repeat(3, 1fr); gap:0.75rem;">
            ...
            <div>
                <label style="font-size:0.75rem; font-weight:700; color:#3b82f6;">🏦 CK Cá nhân</label>
        ...
        <div style="display:flex; justify-content:space-between; align-items:center; margin-top:0.75rem; padding:0.75rem; background:#fef2f2; border-radius:10px; border:1px solid #fecaca;">
            <span style="font-weight:700; color:#dc2626; font-size:0.85rem;">📝 Ghi nợ:</span>
...
function renderCatalog() {
    ...
    if (activePkgs.length > 0) {
        html += '<div style="background:#eef2ff; padding:0.5rem 1rem; font-size:0.75rem; font-weight:800; color:#4f46e5; text-transform:uppercase; border-bottom:1px solid #c7d2fe;">💎 Gói Của Khách (Dùng Buổi)</div>';
    ...
    if (retailItems.length > 0) {
        if (activePkgs.length > 0) {
            ...
            html += '<div style="background:#f8fafc; padding:0.5rem 1rem; font-size:0.75rem; font-weight:800; color:#64748b; text-transform:uppercase; border-top:2px solid #e2e8f0; border-bottom:1px solid #e2e8f0;">🛍 Mua Lẻ (Dịch vụ / Sản phẩm)</div>';
        }
    ...
    // 3. Bán gói mới
    if (pkgs.length > 0) {
        html += '<div style="background:#fef3c7; padding:0.5rem 1rem; font-size:0.75rem; font-weight:800; color:#d97706; text-transform:uppercase; border-top:2px solid #fde68a; border-bottom:1px solid #fde68a;">🎁 Bán Gói Trị Liệu</div>';
...
function renderReceiptView(inv) {
    ...
    html += '<div style="padding:0.75rem 0; text-align:center; font-size:0.8rem; color:#64748b;">'
        ...
        + '<div style="margin-top:0.5rem;">Cảm ơn quý khách! 🙏</div>'
        + '</div>';
